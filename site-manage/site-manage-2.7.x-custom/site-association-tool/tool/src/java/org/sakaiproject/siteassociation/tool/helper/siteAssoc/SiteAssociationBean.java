/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/site-manage/branches/sakai-2.7.x/site-association-tool/tool/src/java/org/sakaiproject/siteassociation/tool/helper/siteAssoc/SiteAssociationBean.java $
 * $Id: SiteAssociationBean.java 71009 2010-01-07 17:47:41Z savithap@umich.edu $
 ***********************************************************************************
 *
...
public class SiteAssociationBean extends BaseBean {
	...
	public void removeAllSites(){
		...
		for(int j = i; j >= first; j--){
			Site removedS = assocSites.get(j);
			assocSites.remove(j);
			if(searchSitesCompleteCopy.contains(removedS)){
				searchSites.add(removedS);
			}

...
public class LongsightPhotoService implements PhotoService {
	...
	public byte[] getPhotoAsByteArray(String userId, boolean hasSitePermission) {
		//String basepath = serverConfigService.getString("sakai.photo.directory", "/mnt/sakai-fs/assetstore/photos");
...
System.out.println("SLO:" + filename);
			
		}
		catch (UserNotDefinedException ee) {
			log.debug("Could not find user: " + filename);
			return null;
		}
		...
		try {
			...
			log.debug("Could not find file: " + filename);
			return null;
		}
	}

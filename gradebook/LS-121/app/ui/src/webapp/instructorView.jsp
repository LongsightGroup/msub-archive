        ...
        sortColumn="#{instructorViewBean.sortColumn}"
				...
				<h:column id="_title">
					...
					<h:panelGroup rendered="#{row.assignment}">
						...
						<h:outputText value=" (#{msgs.add_assignment_extra_credit})" rendered="#{row.associatedAssignment.isExtraCredit && (row.associatedAssignment.category == null || !row.associatedAssignment.category.isExtraCredit) }"/>
					</h:panelGroup>

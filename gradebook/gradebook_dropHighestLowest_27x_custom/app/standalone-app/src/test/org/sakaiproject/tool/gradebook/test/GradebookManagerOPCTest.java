...
//	}
	...
	*/
	public void testGetPointsEarnedCourseGradeRecords() throws Exception{
		...
		gradebookManager.updateGradebook(persistentGradebook);
		assign.setPointsPossible(new Double(5));
//		assign2.setPointsPossible(new Double(5));
//		assign3.setPointsPossible(new Double(10));
//		assign4.setPointsPossible(new Double(10));
//		assign3.setCategory(gradebookManager.getCategory(cate2Long));
//		assign4.setCategory(gradebookManager.getCategory(cate2Long));
...
//			new BigDecimal((((Double)studentIdMap.get(cgr.getStudentId()))) * 0.4 / 5.0 + ((Double)studentIdMap.get(cgr.getStudentId())) * 0.6 / 10.0 ).setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue());
			System.out.println("1----" + new BigDecimal(cgr.getPointsEarned()).setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue());
			System.out.println("2----" + new BigDecimal(cgr.getGradeAsPercentage()).setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue());
			Assert.assertTrue(new BigDecimal(cgr.getPointsEarned()).setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue() == 

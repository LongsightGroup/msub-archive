...
<p class="act">
   ...
   <h:commandButton accesskey="#{evaluationMessages.a_save}" styleClass="active" value="#{evaluationMessages.save_cont}" action="totalScores" type="submit" onclick="document.getElementById('editTotalResults:applyScoreUnsubmitted').value=''">
      <f:actionListener

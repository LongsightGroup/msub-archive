...
<div id="duke-warning" style="color:red;font-weight:bold;font-size:1.3em">ATTENTION: Do not open Sakai in multiple tabs, windows, browsers, or computers while taking a test.</div>
...
<!-- CANCEL BUTTON -->
  <h:commandButton id="cancel1" value="#{deliveryMessages.button_cancel}"  action="select" type="submit"
  ...
  <h:commandButton id="cancel2" value="#{deliveryMessages.button_cancel}" type="button"

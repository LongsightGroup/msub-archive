	...
	public List getSiteNeedResubmitList(String siteId) {
        ...
        public void autoSubmitAssessments() {
                ...
                while (iter.hasNext()) {
	    				...
	    				log.warn("SamigoAutoSubmitJob: Skipping site: " + currentSiteId + ", pubId: " + adata.getPublishedAssessmentId() + ", title: " + adata.getPublishedAssessmentTitle() + ", agentId: " + adata.getAgentId() + ", gradingId: " + adata.getAssessmentGradingId());
	    			}

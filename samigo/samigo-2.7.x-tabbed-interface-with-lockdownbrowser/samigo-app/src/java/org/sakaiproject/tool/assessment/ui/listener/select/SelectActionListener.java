...
public class SelectActionListener
  ...
  public void processAction(ActionEvent ae) throws
	...
	*/
    ...
    // If secure delivery modules are installed and one other than NONE_ID is selected for the assessment,
    // then check with the module if the delivery can continue for this phase (prestart). 

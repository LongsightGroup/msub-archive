    ...
    var ckconfig = {
        ...
        [
            ...
            (sakai.editor.enableResourceSearch
                ? ['ResourceSearch', imageType,'Movie','Flash','Table','HorizontalRule','Smiley','SpecialChar','fmath_formula']
                : [imageType,'Movie','Flash','Table','HorizontalRule','Smiley','SpecialChar','fmath_formula']),
            '/',
		...
		(function() { 
		   ...
		   CKEDITOR.plugins.addExternal('encodedimage',basePath+'encodedimage/', 'plugin.js'); 
			 ...
			 */
			 ...
			 ckconfig.extraPlugins+="fmath_formula,encodedimage";
    })();

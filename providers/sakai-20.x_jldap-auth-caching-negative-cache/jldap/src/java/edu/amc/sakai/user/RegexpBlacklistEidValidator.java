/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/longsight.com/providers/sakai-19.x_jldap-auth-caching-negative-cache/jldap/src/java/edu/amc/sakai/user/RegexpBlacklistEidValidator.java $
 * $Id: RegexpBlacklistEidValidator.java 117310 2012-12-06 16:24:43Z holladay@longsight.com $
 ***********************************************************************************
 *
	...
	private Collection<Pattern> eidBlacklistAsPatterns(
		...
		for ( String patternString : eidBlacklistStrings ) {
			...
			if (StringUtils.startsWith(patternString, "!")) {
				String domain = patternString.substring(1);
				domain = domain.replace(".", "\\.");
				patternString = "^((?!@" + domain + ").)*$";

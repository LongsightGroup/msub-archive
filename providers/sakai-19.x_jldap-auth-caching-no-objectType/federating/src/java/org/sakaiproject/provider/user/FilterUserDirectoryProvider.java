/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/msub/longsight.com/providers/sakai-12.x_jldap-auth-caching/federating/src/java/org/sakaiproject/provider/user/FilterUserDirectoryProvider.java $
 * $Id: FilterUserDirectoryProvider.java 130063 2013-09-30 20:36:32Z holladay@longsight.com $
 ***********************************************************************************
 *
...
public class FilterUserDirectoryProvider implements UserDirectoryProvider, ExternalUserSearchUDP, UsersShareEmailUDP
{
	...
	public List<UserEdit> searchExternalUsers(String criteria, int first, int last, UserFactory factory) {
		...
		if ( myProvider instanceof ExternalUserSearchUDP ) {
			...
			List<UserEdit> l = extSearchUDP.searchExternalUsers(criteria, first, last, factory);
			if(l != null){
				users.addAll(l);
			}
		}

...
public class FileUploadType extends BaseResourceType 
{
	...
	public int getMAX_ZIP_EXTRACT_SIZE() {
		if(MAX_ZIP_EXTRACT_SIZE == null){
			MAX_ZIP_EXTRACT_SIZE = ServerConfigurationService.getInt(ContentHostingService.RESOURCES_ZIP_EXPAND_MAX,ContentHostingService.MAX_ZIP_EXTRACT_SIZE_DEFAULT);
		}

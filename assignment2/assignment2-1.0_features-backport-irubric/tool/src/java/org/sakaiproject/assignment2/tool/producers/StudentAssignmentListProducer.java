/**********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/assignment2/tags/1.0/tool/src/java/org/sakaiproject/assignment2/tool/producers/StudentAssignmentListProducer.java $
 * $Id: StudentAssignmentListProducer.java 70493 2010-09-30 19:02:09Z swgithen@mtu.edu $
 ***********************************************************************************
 *
...
public class StudentAssignmentListProducer implements ViewComponentProducer, ViewParamsReporter {
    ...
    public void fillComponents(UIContainer tofill, ViewParameters viewparams, ComponentChecker checker) {
        ...
        Site curSite = externalLogic.getSite(currContextId);

/**********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/assignment2/tags/1.0/impl/src/java/org/sakaiproject/assignment2/logic/impl/ImportExportLogicImpl.java $
 * $Id: ImportExportLogicImpl.java 69754 2010-08-13 14:30:22Z wagnermr@iupui.edu $
 ***********************************************************************************
 *
                ...
                for (AssignmentDefinition assignDef : toolDefinition.getAssignments()) {
                    if (assignDef != null) {
                        ...
                        try {
                        	...
                        	log.warn("No content review information was saved because there was an exception when creating the content review assignment.");
                        }
                    }
                }
            }

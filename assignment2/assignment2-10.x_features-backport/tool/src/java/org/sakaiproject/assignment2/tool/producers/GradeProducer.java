/**********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/assignment2/branches/sakai-10.x/tool/src/java/org/sakaiproject/assignment2/tool/producers/GradeProducer.java $
 * $Id: GradeProducer.java 86445 2014-05-21 23:14:45Z wagnermr@iupui.edu $
 ***********************************************************************************
 *
...
public class GradeProducer implements ViewComponentProducer, NavigationCaseReporter, ViewParamsReporter, ActionResultInterceptor {
    ...
    private void initIRubric(UIContainer tofill, long gradebookObjectId, String studentId) {
        ...
        String gbToolPlacement = externalLogic.getToolPlacement(contextId, ExternalLogic.TOOL_ID_GRADEBOOK);
        UIInitBlock.make(tofill, "irubric-js-init", "asnn2gradeview.initIRubric", 
            new Object[]{gradebookObjectId,contextId,contextId,studentId,gbToolPlacement});
    }

/**********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/assignment2/branches/sakai-10.x/tool/src/java/org/sakaiproject/assignment2/tool/producers/StudentAssignmentListProducer.java $
 * $Id: StudentAssignmentListProducer.java 79823 2012-06-01 19:25:12Z wagnermr@iupui.edu $
 ***********************************************************************************
 *
...
public class StudentAssignmentListProducer implements ViewComponentProducer, ViewParamsReporter {
    ...
    public void fillComponents(UIContainer tofill, ViewParameters viewparams, ComponentChecker checker) {
        ...
        if(isShowiRubricLink){
            ...
            String gbToolPlacement = externalLogic.getToolPlacement(currContextId, ExternalLogic.TOOL_ID_GRADEBOOK);
            UIInitBlock.make(tofill, "irubric-table-init", "asnn2.initIRubricTable", 
                new Object[] {gradebookIds, currContextId, currContextId, externalLogic.getCurrentUserId(), gbToolPlacement});
        }

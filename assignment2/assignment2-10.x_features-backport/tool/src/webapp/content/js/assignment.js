...
asnn2.initIRubricGradeDetails = function(gradebookId, gradebookUid, siteId, studentId, gradebookPlacementId) {
    jQuery.getJSON(asnn2.makeIRubricUrlPrefix(gradebookPlacementId)+"/iRubricLink.jsp?p=ra&tool=asnn2&gradebookUid="+gradebookUid+"&siteId="+siteId+"&gradebookItemId="+gradebookId,function(data){

...
public class AssignmentActivityProducerImpl implements
    ...
    public boolean allowGetItems(TaggableActivity activity, TaggingProvider provider) {
    ...
    public List<TaggableItem> getItems(TaggableActivity activity, String userId, TaggingProvider provider) {
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }

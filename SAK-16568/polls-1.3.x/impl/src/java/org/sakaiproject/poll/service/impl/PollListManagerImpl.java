...
public class PollListManagerImpl implements PollListManager,EntityTransferrer {
    ...
    public HttpAccess getHttpAccess() {
		...
		public Map<String, String> transferCopyEntities(String fromContext, String toContext, List resourceIds, boolean condition){
			return transferCopyEntities(fromContext, toContext, resourceIds);
		}

		public Map<String, String> transferCopyEntities(String fromContext, String toContext, List resourceIds){
			try{
		...
		public void updateEntityReferences(String toContext, Map<String, String> transversalMap){
			if(transversalMap != null && transversalMap.size() > 0){
				...
				Iterator<Poll> fromPolls = findAllPolls(toContext).iterator();
				while (fromPolls.hasNext()){
					Poll fromPoll = fromPolls.next();
			  		String msgBody = fromPoll.getDescription();
			 		...
			 		if(updated){
			  			fromPoll.setDescription(msgBody);
			  			savePoll(fromPoll);
			  		}		  
			  	}				
			}

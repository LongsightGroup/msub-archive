	...
	public int updateRandomPoolQuestions(SectionFacade section){
		if ((section != null)
			...
			if(verifyItemsDrawSize(itemlist.size(), section.getSectionMetaDataByLabel(SectionDataIfc.NUM_QUESTIONS_DRAWN))){
				...
				Float score = null;
				String requestedScore = (section
						.getSectionMetaDataByLabel(SectionDataIfc.POINT_VALUE_FOR_QUESTION) != null) ? section
								.getSectionMetaDataByLabel(SectionDataIfc.POINT_VALUE_FOR_QUESTION)
								: "";
								...
								Float discount = null;
								String requestedDiscount = (section
										.getSectionMetaDataByLabel(SectionDataIfc.DISCOUNT_VALUE_FOR_QUESTION) != null) ? section
												.getSectionMetaDataByLabel(SectionDataIfc.DISCOUNT_VALUE_FOR_QUESTION)
												: "";

...
public class MessageImpl extends MutableEntityImpl implements Message
{
  ...
  private boolean showForumDeletes;
    ...
    public boolean getShowForumDeletes() {
        String showForumDeletes = ServerConfigurationService.getString("mc.showForumDeletes", "true");
        return Boolean.parseBoolean(showForumDeletes);
    }

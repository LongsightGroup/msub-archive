...
//				}
	 ...
	 * {@inheritDoc}
	 */
	public Map transferCopyEntities(String fromContext, String toContext, List resourceIds)
	{
				...
				for (int i = 0; i < oResources.size(); i++)
				{
					...
					if (toBeImported)
					{
						...
						if (isCollection)
						{
							...
							transversalMap.putAll(transferCopyEntities(oResource.getId(), nId, resourceIds));
						}
						else
						{
							try
...
//			}
	...
	public Map transferCopyEntities(String fromContext, String toContext, List ids, boolean cleanup)
	{	
		Map transversalMap = new HashMap();
		try
		{

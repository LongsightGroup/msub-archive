...
public interface EntityTransferrer
{
	 ...
	 * Returns a map of (fromContextRef -> toContextRef).  Return can be null
	 * 
	 * @param fromContext
	 *        The source context
	 * @param toContext
	 ...
	 * @return       
	 */
	Map<String, String> transferCopyEntities(String fromContext, String toContext, List ids);
	 ...
	 * @return	      
	 */
	Map<String, String> transferCopyEntities(String fromContext, String toContext, List ids, boolean cleanup);

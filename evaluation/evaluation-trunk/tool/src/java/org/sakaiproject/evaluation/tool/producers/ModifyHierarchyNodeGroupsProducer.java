...
//import org.sakaiproject.evaluation.logic.externals.IdUnusedException;
...
public class ModifyHierarchyNodeGroupsProducer implements ViewComponentProducer, ViewParamsReporter, NavigationCaseReporter {
    ...
    private static final String GROUP_TYPE_SITE = EvalConstants.GROUP_TYPE_SITE;
    ...
    public void fillComponents(UIContainer tofill, ViewParameters viewparams, ComponentChecker checker) {
        ...
        List<EvalGroup> evalGroups = commonLogic.getEvalGroupsForUser(commonLogic.getAdminUserId(), EvalConstants.PERM_BE_EVALUATED); //TODO: make this the current user, not admin
        // Add the groups provided by our external hierarchy...
        ...
        for (String hierarchyEvalGroupId : hierarchyEvalGroupIds) {
        	EvalGroup c = null;
        	String siteId = hierarchyEvalGroupId.substring(6);
        	//System.out.println("hierachy site id: "+siteId);
        	try {
        	    Site site = siteService.getSite(siteId);
        	    //System.out.println("site title: "+site.getTitle());
        	    c = new EvalGroup( hierarchyEvalGroupId, site.getTitle(), GROUP_TYPE_SITE );
        	} catch (Exception e) {

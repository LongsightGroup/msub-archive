...
public class HierarchyTreeNodeSelectRenderer {
    ...
    * @param level
    */
   private void renderSelectHierarchyNode(UIContainer tofill, EvalHierarchyNode node, int level, EvalViewParameters evalViewParams, Set<String> accessNodeIds, Set<String> parentNodeIds, List<String> selectedNodes, List<String> selectedGroups) {

 ...
 * $URL: https://source.sakaiproject.org/contrib/evaluation/branches/1.3.x/tool/src/java/org/sakaiproject/evaluation/tool/locators/HierarchyNodeGroupsLocator.java $
...
public class HierarchyNodeGroupsLocator implements BeanLocator {
    ...
    public Object locateBean(String name) {
        ...
        if (togo == null) {
            ...
            // we're going to add all hierarchy provided groups, regardless of if user is enrolled.

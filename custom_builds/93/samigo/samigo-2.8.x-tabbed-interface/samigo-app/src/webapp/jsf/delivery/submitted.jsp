...
<div class="tier1">
  <h:panelGrid columns="2" cellpadding="3" cellspacing="3">
    ...
    <h:commandButton value="#{deliveryMessages.button_continue}" type="button" 
       ...
       style="act" onclick="javascript:if(window.name!='nsc-iframe') {window.open('#{delivery.selectURL}','_top')} else { alert('Thanks!');}" onkeypress="javascript:if(window.name!='nsc-iframe') {window.open('#{delivery.selectURL}','_top')} else { alert('Thanks!');}" />

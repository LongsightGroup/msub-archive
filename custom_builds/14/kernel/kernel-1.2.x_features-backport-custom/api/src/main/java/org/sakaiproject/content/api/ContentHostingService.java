...
public interface ContentHostingService extends EntityProducer
{
    ...
    public static final String COLLECTION_DROPBOX = "/group-user/";
        ...
        /** The reference id for dropboxes zip. */
    public static final String COLLECTION_DROPBOX_ZIP = "/group-user-zip/";
    ...
    public static final String RESOURCES_ZIP_EXPAND_MAX = "resources.zip.expand.max";
    
    public static final String RESOURCES_ZIP_ENABLE = "resources.zip.enable";
    
    public static final String RESOURCES_ZIP_ENABLE_EXPAND = "resources.zip.enable.expand";
    
    public static final String RESOURCES_ZIP_ENABLE_COMPRESS = "resources.zip.enable.compress";
    
    public static final int MAX_ZIP_EXTRACT_SIZE_DEFAULT = 1000;
    ...
    *
    ...
    /**
 	 * Retrieve ZIP of all dropbox resources. See SAK-15296
 	 */

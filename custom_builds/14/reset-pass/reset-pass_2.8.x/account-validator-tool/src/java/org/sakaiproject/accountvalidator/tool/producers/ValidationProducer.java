	...
	public void fillComponents(UIContainer tofill, ViewParameters viewparams,
		...
		if (viewparams instanceof ValidationViewParams) {
			...
			if (va == null) {
				...
				String guestLoginUrl = serverConfigurationService.getString("accountvalidator.guestLoginUrl", "");
				if(!"".equals(guestLoginUrl)){
					UILink.make(tofill, "message-instructions-url-confirmed", messageLocator.getMessage("msg.loginLinkGuestLogin"), guestLoginUrl);
				}
				String resubmitPwRequestUrl = serverConfigurationService.getString("accountvalidator.resubmitPwRequestUrl", "");
				if(!"".equals(resubmitPwRequestUrl)){
					UILink.make(tofill, "message-instructions-url-expired", messageLocator.getMessage("msg.submitNewPwRequest"), resubmitPwRequestUrl);
				}
				return;

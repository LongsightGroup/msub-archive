	...
	*/
									...
									SessionState state)
	{
		...
		if (RESOURCES_MODE_DROPBOX.equalsIgnoreCase((String) state.getAttribute(STATE_MODE_RESOURCES)))
		{
			...
			// accessPointUrl for Downloading all drop boxes
			context.put("accessPointUrl", getDropboxCollectionZipUrl());
			context.put("isDropBoxMaintainer", new Boolean(ContentHostingService.isDropboxMaintainer()));
		}
		else
		{
	...
	*/
										...
										SessionState state)
	{
		...
		if (dropboxMode)
		{
			...
			// accessPointUrl for Downloading all drop boxes
			context.put("accessPointUrl", getDropboxCollectionZipUrl());
			context.put("isDropBoxMaintainer", new Boolean(contentService.isDropboxMaintainer()));
		}
		else
		{
			//context.put("dropboxMode", Boolean.FALSE);
...
//				}
	...
	public String getDropboxCollectionZipUrl()
	{
		...
		return "/access/content/group-user-zip/" + siteId + Entity.SEPARATOR;
	}

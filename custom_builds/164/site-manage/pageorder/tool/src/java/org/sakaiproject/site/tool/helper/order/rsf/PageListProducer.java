...
public class PageListProducer 
    ...
    public String ALLOW_REMOVE_TOOL = "org.sakaiproject.site.tool.helper.order.rsf.PageListProducer.allowRemoveTool";
            ...
            for (Iterator<String> it = sitePages.keySet().iterator(); it.hasNext(); ) {
                ...
                if (page.getTools().size() == 1) {
                    ...
                    if (!handler.isRequired(tool.getToolId()) && !"sakai.sitesetup".equals(tool.getToolId())
                            && !"sakai.siteinfo".equals(tool.getToolId()) && serverConfigurationService.getBoolean(ALLOW_REMOVE_TOOL, true)) {

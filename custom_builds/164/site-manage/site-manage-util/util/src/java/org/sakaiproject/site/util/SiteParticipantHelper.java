			...
			for (Iterator<String> i=providerCourseList.iterator(); i.hasNext();)
			{
				...
				try
				{
					...
					if (section != null)
					{
                        ...
                        addOfficialInstructorOfRecord(participantsMap, realm, section.getTitle(), enrollmentSet);
					...
					try
					{
                        ...
                        if (member == null && !refreshed) {
                            try {
                                ...
                                M_log.warn("SiteParticipantHelper:addOfficialInstructorOfRecord " + exc.getMessage());
                            }
                        }
						if (member != null)
						{

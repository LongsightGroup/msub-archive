...
public class SiteConstants {
    ...
    public final static String SAKAI_PROPERTY_ALLOW_OFFICIAL_DESCRIPTION = "site.allow.official.description";

    //Property to show section eid and description in section object list during site creation.  This is to make SAK-19300 configurable.
    public final static String SAKAI_PROPERTY_SHOW_SECTION_METADATA = "sitesetup.showSectionMetadata";
    ...
    public final static String SITE_ACTIVE = "active";

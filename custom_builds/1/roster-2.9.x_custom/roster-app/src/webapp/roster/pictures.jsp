        ...
        <h:form id="roster_form">
            ...
            <t:dataTable
                ...
                <h:column>
                    ...
                    <t:div>
                        <h:commandLink action="#{profileBean.displayProfile}" value="View Profile" title="#{msgs.show_profile}" rendered="#{pictures.renderProfileLinks}">
                            <f:param name="participantId" value="#{participant.user.id}" />
                            <f:param name="returnPage" value="pictures" />
                        </h:commandLink>
                        <h:outputText value="View Profile" rendered="#{ ! pictures.renderProfileLinks}" />
                    </t:div>
                </h:column>
            </t:dataTable>
        </h:form>

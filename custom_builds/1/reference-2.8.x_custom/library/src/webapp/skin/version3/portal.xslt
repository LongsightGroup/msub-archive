...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
   ...
   <head>
    ...
    <meta http-equiv="Content-Style-Type" content="text/css" />
	  ...
	  <script type="text/javascript" language="JavaScript" src="/access/content/public/scripts/ohsu_scripts.js">
         <xsl:value-of select="' '"/>
      </script>
	  <script>
	  	//Get a nice description of the course
		$(document).ready(function() {
			if(typeof updateCourseDescription == 'function') {
				updateCourseDescription("<xsl:value-of select="//tabsSites/site[@selected='true']/url" />", "siteTitle");
			}
		});
	  </script>
   </head>
...
<script type="text/javascript">
try {
var pageTracker = _gat._getTracker("UA-2417956-2");
...
your browser doesn't support iframes
   ...
   <xsl:template match="category[key!='org.theospi.portfolio.portal.model.ToolCategory.uncategorized']">
      ...
      <xsl:if test="$content != 'true'">
         ...
         <!-- ansorgej@ohsu.edu - commenting out to override display of tool subcategories <li>
            <div class="toolSubMenuHolder">
               ...
               <div class="toolSubMenuHolder_content">
                  ...
                  <div class="toolSubMenuHolder_tools">
                     ...
                     <!-- ansorgej@ohsu.edu - commenting out to override display of tool subcategories 
					 </ul>
                  </div>
               </div>
            </div>
...
<div id="siteNavWrapper">
   ...
   <div id="mastHead">
      ...
      <div id="mastLogin">
		...
		<xsl:apply-templates select="/portal/config/extra/switchRoleUrl" />
           <div id="loginLinks">
		   Welcome, <xsl:value-of select="currentUser/first"/> - 
              <a target="_parent">
                 <xsl:attribute name="href">
         ...
         <xsl:when test="currentUser">
            <div id="siteNav">
               ...
               <div id="linkNav">
                  ...
                  <ul id="siteLinkList">
				  <li>
				  <a title="Edit Tabs" alt="Edit Tabs" >
                                 <xsl:attribute name="href">/xsl-portal/directtool/sakai.preferences?sakai.site=~<xsl:value-of select="/portal/currentUser/id" />
                                 </xsl:attribute>
                                <img alt="Edit Quicklinks" name="editQuickLinks" id="editQuickLinks" width="37" height="17" border="0">
                                   <xsl:attribute name="src">
                                     <xsl:value-of select="substring-before(//skins/skin,'portal.css')"/><xsl:text>images/edit_tabs.gif</xsl:text>
                                 </xsl:attribute>
                                 </img>
				 </a>
				 </li>
                     ...
                     <xsl:if test="/portal/sites/tabsMoreSites/site">
                        <li class="more-tab">
                           <a href="#" onclick="return dhtml_more_tabs();">
                              ...
                              <span class="outer"><span class="inner">My Sites</span></span>
                           </a>
                        </li>
                     </xsl:if>
         ...
         <div>
            ...
            <div id="more_tabs_instr">
				<a title="Edit Tabs" alt="Edit Tabs" >
					...
					Click here</a> to hide or unhide courses and configure your tab bar.
            </div>
         </div> <!-- /  -->
      </div> <!-- /selectNav -->
   </div>
         ...
         <li>
            <a>
               ...
               <xsl:if test="@popUp='true'">
                  ...
                  <xsl:attribute name="onclick">window.open('<xsl:value-of select="popUrl"/>', 'Sakai_Popup', 'resizable=yes,toolbar=no,scrollbars=yes,width=800,height=600')</xsl:attribute>
               </xsl:if>
               <xsl:attribute name="accesskey">
                  <xsl:value-of select="../../@order" />
               </xsl:attribute>
   ...
   <xsl:template name="page-content-columns">
      ...
      <div id="content">
         <div id="col1of2">
            ...
            <div class="portlet">
			<!-- Start of OHSU Academic and Student Affairs Announcemnts Modifcation -->
<xsl:if test="/portal/sites/tabsSites/site[@selected='true' and @myWorkspace='true']">
<div class="portletTitleWrap">
<div class="portletTitle">
<div class="title">
<h2>Academic and Student Affairs News</h2>
</div>
<div class="action">
<a onclick="openWindow('https://sakai.ohsu.edu/xsl-portal/help/main?help=sakai.iframe.site', 'Help',
  'resizable=yes,toolbar=no,scrollbars=yes,menubar=yes,width=800,height=600'); return false
      " href="https://sakai.ohsu.edu/xsl-portal/help/main?help=sakai.iframe.site" target="_blank" accesskey="h"><img border="0" alt="Help" src="/library/image/transparent.gif"/></a>
</div>
</div>
</div>
<div class="portletMainWrap">
<iframe width="100%" height="200" frameborder="0" scrolling="auto" title="Worksite Information " src="https://sakai.ohsu.edu/access/content/public/announcements/announcements.htm" name="Announcements" marginwidth="0" marginheight="0" id="Announcements" class="portletMainIframe" style="height: 195px;">

</iframe>
</div>
</xsl:if>
<!-- End of OHSU Academic and Student Affairs Announcemnts Modifcation -->
         <xsl:for-each select="$page/columns/column[@index='0']/tools/tool">
            <xsl:call-template name="tool">
               <xsl:with-param name="tool" select="."/>
            </xsl:call-template>
   ...
   <xsl:apply-templates select=".">
      <xsl:with-param name="content" select="'false'"/>
         ...
         <li>
               ...
               <xsl:attribute name="onclick">
                  window.open('<xsl:choose>
				  <xsl:when test="config/helpUrl[normalize-space(.)]">
				  <xsl:value-of select="config/helpUrl"/>
				  </xsl:when>
				  <xsl:otherwise>/xsl-portal/help/main</xsl:otherwise>
				  </xsl:choose>','Help','resizable=yes,toolbar=no,scrollbars=yes, width=800,height=600')
               </xsl:attribute>
...
<div id="footerHelp">
<strong>OHSU Sakai Helpdesk</strong>: Phone (503) 494-7074 | e-mail <a href="mailto:sakai@ohsu.edu">sakai@ohsu.edu</a> | Web <a href="http://atech.ohsu.edu/help" target="_blank">http://atech.ohsu.edu/help</a>
</div>
...
<div class="portletBody">
   ...
   <xsl:template match="@*|*">
	...
	<xsl:template match="switchRoleUrl">
		<div id="roleSwitch">
		<xsl:choose>
			<xsl:when test="/portal/config/extra/roleUrlValue">
				<a>
				<xsl:attribute name="href">
					<xsl:value-of select="/portal/config/extra/switchRoleUrl"/>
				</xsl:attribute>
				Exit <xsl:value-of select="/portal/config/extra/roleUrlValue"/> View
				</a>
			</xsl:when>
			<xsl:otherwise>
			<label for ="roleSwitchSelect">View Site As:</label>
			<select id="roleSwitchSelect" > 
				<xsl:attribute name="onchange">
				if (this.options[this.selectedIndex].value != '') { parent.location = this.options[this.selectedIndex].value; } else { this.selectedIndex = 0; }
				</xsl:attribute>	 
		    	<option value="" selected="selected">- Select Role -</option> 	
				<xsl:for-each select="/portal/config/extra/siteRoles-list/siteRoles"> 
		        <option>
				<xsl:attribute name="value">
					<xsl:value-of select="/portal/config/extra/switchRoleUrl"/><xsl:value-of select="." />
				</xsl:attribute>
				<xsl:value-of select="." />
				</option>
				</xsl:for-each> 	 
...
<metaInformation>
	<scenarios>
		<scenario default="no" name="Scenario1" userelativepaths="yes" externalpreview="no" url="test.xml" htmlbaseurl="https://sakai.ohsu.edu/" outputurl="" processortype="saxon8" useresolver="yes" profilemode="0" profiledepth="" profilelength=""
		...
		<scenario default="no" name="Scenario2" userelativepaths="yes" externalpreview="no" url="test2.xml" htmlbaseurl="https://sakai.ohsu.edu/" outputurl="" processortype="saxon8" useresolver="yes" profilemode="0" profiledepth="" profilelength=""
		          urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext="" validateoutput="no" validator="internal"
		          customvalidator="">
			<advancedProp name="sInitialMode" value=""/>
			<advancedProp name="bXsltOneIsOkay" value="true"/>
		...
		<scenario default="yes" name="Workspace" userelativepaths="yes" externalpreview="no" url="workspace.xml" htmlbaseurl="https://sakai.ohsu.edu/" outputurl="" processortype="saxon8" useresolver="yes" profilemode="0" profiledepth="" profilelength=""
		          urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext="" validateoutput="no" validator="internal"
		          customvalidator="">
			<advancedProp name="sInitialMode" value=""/>
			<advancedProp name="bXsltOneIsOkay" value="true"/>

...
FCKConfig.ToolbarSets["Default"] = [
        ...
        ['Bold','Italic','Underline','StrikeThrough','Subscript','Superscript','-','SpellCheck'],
        ['OrderedList','UnorderedList','Outdent','Indent','Blockquote'],
        ['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','TextColor','BGColor'],
        ['Link','Unlink','Anchor'],
        ['Image','Movie','Flash','Table','Rule','Smiley','SpecialChar'],['MathEdit'],['Style'],
...
FCKConfig.SpellerPagesServerScript = '/proxy/spellcheck/'

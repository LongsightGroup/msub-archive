/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/sam/trunk/samigo-app/src/java/org/sakaiproject/tool/assessment/ui/bean/author/CalculatedQuestionAnswerIfc.java $
 * $Id: CalculatedQuestionAnswerIfc.java 106463 2012-04-02 12:20:09Z david.horwitz@uct.ac.za $
 ***********************************************************************************
 *
...
public interface ImageMapQuestionAnswerIfc {
     ...
     * begin with an alpha character and can then hae any number of alpha-numeric
     * characters.
     * @return
     */
     ...
     * "text" field.  Formulas and variables are both encoded differently,

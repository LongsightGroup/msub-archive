    ...
    implements OAuthTokenService
{
    ...
    public OAuthProvider createOAuthProvider (String providerName,
        ...
        throws DataIntegrityException, PersistenceException
    {
        return createOAuthProvider(providerName, description, requestTokenURL, userAuthorizationURL, accessTokenURL, realm,
                                   consumerKey, consumerSecret, null, OAuthSignatureMethod.HMAC_SHA1, null, true);
    }
    ...
    {
        return createOAuthProvider(providerName, description, requestTokenURL, userAuthorizationURL, accessTokenURL, realm,
                                   consumerKey, hmacSha1Key, rsaSha1Key, signingMethod, null, true);
    }
    ...
    {
        return createOAuthProvider(providerName, description, requestTokenURL, userAuthorizationURL, accessTokenURL, realm,
                                   consumerKey, hmacSha1Key, rsaSha1Key, signingMethod, null, enabled);
    }
    ...
    {
        return createOAuthProvider(providerName, description, requestTokenURL, userAuthorizationURL, accessTokenURL, realm,
                                   consumerKey, consumerSecret, null, OAuthSignatureMethod.HMAC_SHA1, additionalHeaders, true);
    }
    ...
    {
        return createOAuthProvider(providerName, description, requestTokenURL, userAuthorizationURL, accessTokenURL, realm,
                                   consumerKey, hmacSha1Key, rsaSha1Key, signingMethod, additionalHeaders, true);        
    }
    ...
    public void updateOAuthProvider(OAuthProvider provider)
        throws NoSuchObjectException, PersistenceException
    {
        assertSignatureMethodHasValidKey (provider.getSignatureMethod(), provider.getHmacSha1SharedSecret(), provider.getRsaSha1Key());
        ...
        throws NoSuchObjectException, PersistenceException
    {
        ...
        updateOAuthProvider (uuid, providerName, description, requestTokenURL, userAuthorizationURL, accessTokenURL,
                             realm, consumerKey, consumerSecret, null, OAuthSignatureMethod.HMAC_SHA1, additionalHeaders,
                             enabled);

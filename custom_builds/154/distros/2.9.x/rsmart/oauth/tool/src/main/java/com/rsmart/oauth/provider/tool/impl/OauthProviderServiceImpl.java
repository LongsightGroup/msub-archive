    ...
    implements OAuthProviderService
{
        ...
        throws PersistenceException
    {
        ...
        OAuthSignatureMethod
            signatureMethod = provider.getSignatureMethod();//OAuthSignatureMethod.HMAC_SHA1;
        boolean
        ...
        throws NoSuchObjectException, PersistenceException
    {
        try
        {
            ...
            OAuthSignatureMethod
                signingMethod = provider.getSignatureMethod();//OAuthSignatureMethod.HMAC_SHA1;

            boolean enabled = provider.isEnabled();

//            if (rsaSha1Key != null && rsaSha1Key.trim().length() > 0)
//                signingMethod = OAuthSignatureMethod.RSA_SHA1;

...
public class LoginTool extends HttpServlet
{
	...
	protected void sendForm(HttpServletRequest req, HttpServletResponse res) throws IOException
	{
		...
		final String loginHtml = "<table class=\"login\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" summary=\"layout\">" + "		<tr>"
				...
				+ "                                        MSG" + "							<table border=\"0\" class=\"loginform\" summary=\"layout\">RESET_PASSWORD_URL"
        ...
        String forgotPasswordLink = ServerConfigurationService.getString("forgot.passwork.link");
        ...
        if (forgotPasswordLink == null || "".equals(forgotPasswordLink)) {
            html = html.replaceAll("RESET_PASSWORD_URL", "");
        } else {
            html = html.replaceAll("RESET_PASSWORD_URL", "<tr><td>" + forgotPasswordLink + "</td></tr>");
        }

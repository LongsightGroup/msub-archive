...
public class EditorConfiguration 
{
    ...
    public static boolean enableWirisEditor(){

        String wirisFormulaDirectory = ServerConfigurationService.getString("wirisformuladirectory");

        if(wirisFormulaDirectory != null && !wirisFormulaDirectory.isEmpty()){
            return true;
        } else {
            return false;
        }
    ...
    public static boolean forceAlternativeText(){
		return "true".equalsIgnoreCase(ServerConfigurationService.getString("wysiwyg.editor.forceAlternativeText"));
    }

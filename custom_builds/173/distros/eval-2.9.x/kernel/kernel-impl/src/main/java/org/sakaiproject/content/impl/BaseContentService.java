...
//
    ...
    protected void processVirusQueue() {
...
//					String oldReference = siteIdSplice(tId, fromSiteId);
...

	{
		...
		if (toCollection != null)
		{
					...
					if (toBeImported)
					{
						...
						if (isCollection)
						{
							...
							try
							{
                                ...
                                setPubView(edit.getId(), isPubView(oResource.getId()));
							...
							{
                                 M_log.warn("problem copying collection into site: " + toContext + " from site: " + fromContext, e);
							}
							catch (IdInvalidException e)
							{
                                M_log.warn("problem copying collection into site: " + toContext + " from site: " + fromContext, e);
						...
						else
						{
							...
							{
                                M_log.warn("problem copying resource into site: " + toContext + " from site: " + fromContext, e);
							}
							catch (IdUsedException e)
							{
                                M_log.warn("problem copying resource into site: " + toContext + " from site: " + fromContext, e);
			...
			{
                M_log.warn("problem copying resources into site: " + toContext + " from site: " + fromContext, e);
			}
			catch (TypeException e)
			{
                M_log.warn("problem copying resources into site: " + toContext + " from site: " + fromContext, e);
		...
		try
		{
			if(cleanup == true)
			{
				...
				if(oCollection != null)
				{
                    ...
                    threadLocalManager.set("members@" + oCollection.getId(), null);
                    threadLocalManager.set("getResources@" + oCollection.getId(), null);
                    threadLocalManager.set("getCollections@" + oCollection.getId(), null);
				}
			}
		}
		catch (Exception e)
		{
			M_log.error("BaseContentService Resources transferCopyEntities Error" + e);
		}

/**********************************************************************************
 * $URL: https://svn.rsmart.com/svn/vendor/branches/sakai-kernel/rsmart-cle/kernel-impl/src/main/java/org/sakaiproject/site/impl/BaseToolConfiguration.java $
 * $Id: BaseToolConfiguration.java 26198 2011-04-08 19:28:14Z jcrodriguez $
 ***********************************************************************************
 *
		...
		ToolConfiguration, Identifiable
{
			...
			String layoutHints, String pageId, String siteId, String skin, int pageOrder)
	{
      ...
      try {
         m_page = siteService.getSite(siteId).getPage(pageId);

/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/login/branches/sakai-2.7.x/login-authn-tool/tool/src/java/org/sakaiproject/login/tool/AuthnPortal.java $

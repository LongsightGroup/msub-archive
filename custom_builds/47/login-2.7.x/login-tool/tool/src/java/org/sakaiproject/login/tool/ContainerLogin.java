/**********************************************************************************
 * $URL: https://source.sakaiproject.org/svn/login/branches/sakai-2.7.x/login-tool/tool/src/java/org/sakaiproject/login/tool/ContainerLogin.java $
 * $Id: ContainerLogin.java 59674 2009-04-03 23:05:58Z arwhyte@umich.edu $
 ***********************************************************************************
 *
...
public class ContainerLogin extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
	{
		...
		if(M_log.isDebugEnabled()){
			...
			String name;
			String value;
			requestInfo.append("\n\nContainerLogin.doGet\n");
			for (; enums.hasMoreElements(); ) {
				name = (String)enums.nextElement();
//				value= (String)req.getParameter(name);
//				requestInfo.append("\n").append(name).append(": ").append(value);
			...
			M_log.debug(requestInfo.toString());
		}

...
public class CourseGradeDetailsBean extends EnrollmentTableBean {
    ...
    private ExternalGradesBean externalGradesBean;
   ...
   public class ScoreRow implements Serializable {
	...
	private void saveGrades() throws StaleObjectModificationException {
      if (getExternalGradesBean().isExternalGrades()) {
         getExternalGradesBean().saveGrades();
      }
   ...
   public ExternalGradesBean getExternalGradesBean() {
      if (externalGradesBean == null) {
         externalGradesBean = new ExternalGradesBean();
      }
      return externalGradesBean;
   }
}

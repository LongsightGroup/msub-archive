	...
	<div class="portletBody">
	  <h:form id="gbForm">
		...
		<t:dataTable cellpadding="0" cellspacing="0"
			...
			styleClass="listHier"
         binding="#{courseGradeDetailsBean.externalGradesBean.tableData}">
			<h:column>
				<f:facet name="header">
			...
			<h:column rendered="#{courseGradeDetailsBean.externalGradesBean.externalGrades}">
				<f:facet name="header">
		            <t:commandSortHeader columnName="externalUserId" propertyName="externalUserId" arrow="true" immediate="false" actionListener="#{courseGradeDetailsBean.sort}">
						<h:outputText value="#{msgs.assignment_details_student_id}"/>
		            </t:commandSortHeader>
				</f:facet>
				<h:outputText value="#{courseGradeDetailsBean.externalGradesBean.userIds[scoreRow.enrollment.user.displayId]}"/>
			</h:column>
         ...
         <h:column rendered="#{!courseGradeDetailsBean.externalGradesBean.externalGrades}">
			...
			<%@include file="/inc/externalGradeColumns.jspf"%>
		...
		<div class="act">
			...
			<%@include file="/inc/externalSubmitButtons.jspf"%>

...
-->
  <f:view>
    <html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
      ...
      <c:if test="${delivery.isMathJaxEnabled}">
          <script type="text/javascript" language="JavaScript" src="/library/js/MathJax/MathJax.js?config=default">MathJax.Hub.Config({messageStyle: "none"});</script>
      </c:if>

 ...
 */
@CommonsLog
public class SyllabusEntityProvider extends AbstractEntityProvider implements EntityProvider, AutoRegisterEntityProvider, ActionsExecutable, Outputable, Describeable, DescribePropertiesable
{
	...
	public Syllabus getSyllabusForSite(EntityView view) {
		...
		while(iter.hasNext()) {
			...
			//NOTE not available in 2.8 or 2.9
			/*

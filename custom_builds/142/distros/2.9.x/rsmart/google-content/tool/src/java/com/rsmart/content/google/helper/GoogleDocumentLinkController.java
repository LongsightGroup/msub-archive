    ...
    extends AbstractWizardFormController
{
         ...
         throws Exception
    {
        ...
        if (page == 0)
        {
            ...
            final StringBuilder
                sbUrl = new StringBuilder(Web.serverUrl(req)),
                oauthDoneURL = new StringBuilder();

            sbUrl.append(req.getContextPath()).append(getOauthCallbackPath());

            URL
                url = null;
            try
            {
                url = google.createOAuthRequestURL(sbUrl.toString());
            }
            catch (GoogleDocsException e)
            {
        ...
        else if (page == 1)
        {
            try
            {
                final Map <String, List<GoogleDocDescriptor>>
        ...
        throws Exception
    {
        ...
        getContentHostingService().commitResource(resource, defaultNotification);

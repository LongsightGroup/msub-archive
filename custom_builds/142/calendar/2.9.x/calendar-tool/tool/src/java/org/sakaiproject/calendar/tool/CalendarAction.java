...
extends VelocityPortletStateAction
{
   ...
   Properties configProps = null;
	...
	CalendarUtil calendarUtil)
	{
		...
		Time endTime = TimeService.newTimeLocal(calendarUtil.getYear(),calendarUtil.getMonthInteger(),calendarUtil.getDayOfMonth(),23,59,59,999);
	...
	int day)
	{
		...
		Time endTime = TimeService.newTimeLocal(year,month,day,23,59,59,999);
 ...
 */
			...
			try
			{
				...
				if (state.getPrevState() != null)
				{
					...
					|| (state.getPrevState()).equalsIgnoreCase("year"))
					{
						...
						Time timeObj2 = TimeService.newTimeLocal(year,month,day,7,59,59,999);
						...
						else
						{
							...
							timeObj2 = TimeService.newTimeLocal(year,month,day,17,59,59,999);
							...
							else
							{
								...
								timeObj2 = TimeService.newTimeLocal(year,month,day,23,59,59,999);
								timeRangeObj = TimeService.newTimeRange(timeObj,timeObj2);
								vec  = CalendarService.getEvents(getCalendarReferenceList(portlet, state.getPrimaryCalendarReference(),isOnWorkspaceTab()), timeRangeObj);
	...
	protected void buildListContext(VelocityPortlet portlet, Context context, RunData runData, CalendarActionState state)
	{
		...
		context.put("ddEndYear", Integer.valueOf(userCal.get(java.util.Calendar.YEAR) + 10));

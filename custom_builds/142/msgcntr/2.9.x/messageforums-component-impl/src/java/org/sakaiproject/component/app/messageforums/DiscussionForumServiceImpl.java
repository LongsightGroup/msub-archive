/**********************************************************************************
 * $URL: https://svn.rsmart.com/svn/vendor/branches/sakai/rsmart-cle/msgcntr/messageforums-component-impl/src/java/org/sakaiproject/component/app/messageforums/DiscussionForumServiceImpl.java $
 * $Id: DiscussionForumServiceImpl.java 34918 2012-04-09 20:12:14Z ktakacs $
 ***********************************************************************************
 *
...
public class DiscussionForumServiceImpl implements DiscussionForumService, EntityTransferrer, EntityTransferrerRefMigrator {
    ...
    public Map<String, String> transferCopyEntitiesRefMigrator(String fromContext, String toContext, List resourceIds) {
        ...
        try {
            ...
            Site currentSite = SiteService.getSite(fromContext);
            Site newSite = SiteService.getSite(toContext);
            String oldSiteTitle = currentSite.getTitle();
            String newSiteTitle = newSite.getTitle();
            ...
            if (fromDfList != null && !fromDfList.isEmpty()) {
                for (int currForum = 0; currForum < fromDfList.size(); currForum++) {
                    ...
                    if (newForum != null) {
                        ...
                        if (fromForum.getTitle().contains(oldSiteTitle)) {
                            newForum.setTitle(getResourceBundleString("default_forum", new Object[]{(Object) newSiteTitle}));
                        } else {

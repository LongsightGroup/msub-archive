/**********************************************************************************
 * $URL: https://svn.rsmart.com/svn/vendor/branches/sakai/rsmart-cle/msgcntr/messageforums-app/src/java/org/sakaiproject/tool/messageforums/ui/DiscussionMessageBean.java $
 * $Id: DiscussionMessageBean.java 27716 2011-06-17 19:24:15Z ktakacs $
 ***********************************************************************************
 *
...
public class DiscussionMessageBean
{
  ...
  private boolean authorCanBeGraded;
...
LOG.debug("... before return getAuthorEmail(): userEmail = " + userEmail);
    ...
    public void setAuthorCanBeGraded(boolean authorCanBeGraded){
        this.authorCanBeGraded = authorCanBeGraded;
    }
    public boolean getAuthorCanBeGraded(){
        return authorCanBeGraded;
    }
}

 ...
 * 
 */
@WebServiceClient(name = "Authentication_x0020_Web_x0020_Service", targetNamespace = "http://ibridge.isgsolutions.com/Authentication/", wsdlLocation = "http://members.dhi.org/iservices/Authentication.asmx?wsdl")
	...
	static {
		...
		try {
			...
			baseUrl = com.isgsolutions.ibridge.authentication.AuthenticationX0020WebX0020Service.class
					.getResource(".");
			url = new URL(baseUrl,
					"http://members.dhi.org/iservices/Authentication.asmx?wsdl");
		} catch (MalformedURLException e) {
			logger.warning("Failed to create URL for the wsdl Location: 'http://members.dhi.org/iservices/Authentication.asmx?wsdl', retrying as a local file");

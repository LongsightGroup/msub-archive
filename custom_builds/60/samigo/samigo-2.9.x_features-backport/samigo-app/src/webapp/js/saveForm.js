...
function SaveFormContentAsync(toUrl, formId, buttonName, updateVar, updateVar2, repeatMilliseconds, ok ) {
	...
	if (saveok) {
	    ...
	    alert("Attempt to save your work automatically failed. One common cause is that you have a second window open on Tests and Quizzes. We strongly suggest that you not continue working in this window. If you go to the top level of Tests and Quizzes, you can restart this test or quiz.");
	}
	window.status = "";

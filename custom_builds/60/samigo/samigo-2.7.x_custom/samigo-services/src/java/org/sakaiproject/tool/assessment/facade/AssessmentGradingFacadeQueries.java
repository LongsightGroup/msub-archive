...
*/
	...
	public void autoSubmitAssessments() {
		...
		List listNoRetractDate = getHibernateTemplate()
				.find("select new AssessmentGradingData(a.assessmentGradingId, a.publishedAssessmentId, " +
						...
						" and current_timestamp() >= c.dueDate and c.retractDate is null and a.status not in (4, 5) and c.autoSubmit = ? " +

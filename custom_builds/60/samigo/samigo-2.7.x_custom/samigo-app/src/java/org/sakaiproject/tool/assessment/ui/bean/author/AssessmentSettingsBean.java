...
// dateString is in client timezone, change it to server time zone
  ...
  public SelectItem[] getGroupsForSite(){
	  ...
	  Site site = null;
	  try {
System.out.println("sam00:" + ToolManager.getCurrentPlacement().getContext());
		 site = SiteService.getSite(ToolManager.getCurrentPlacement().getContext());
System.out.println("sam01:" + site.getId());
		 Collection groups = site.getGroups();
System.out.println("sam02:" + groups.size());
	     if (groups != null && groups.size() > 0) {
	    	 groupSelectItems = new SelectItem[groups.size()];
	    	 Iterator groupIter = groups.iterator();
	    	 while (groupIter.hasNext()) {
	    		 Group group = (Group) groupIter.next();
System.out.println("sam03:" + group.getId() + ":" + group.getTitle());
...
System.out.println("sam04:" + displayDescription);

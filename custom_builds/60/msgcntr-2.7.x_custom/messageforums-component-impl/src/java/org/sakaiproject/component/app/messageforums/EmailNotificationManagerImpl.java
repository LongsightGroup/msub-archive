	...
	public EmailNotification getEmailNotification(final String userId) {
		...
		if (emailNotification == null) {
            ...
            if (notificationDefault.equals("0")) {
                newEmailNotification.setNotificationLevel(EmailNotification.EMAIL_NONE);
            } else if (notificationDefault.equals("2")) {
                newEmailNotification.setNotificationLevel(EmailNotification.EMAIL_REPLY_TO_ANY_MESSAGE);
            } else {

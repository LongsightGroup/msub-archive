...
public class MenuEntry implements MenuItem
{
    ...
    protected boolean m_submitFormAction = false;
	/**
	 * Construct a menu.
	 */
    ...
    public MenuEntry(String title, String icon, boolean enabled, int checked, String action, boolean submitForm)
	{
		m_title = title;
		m_icon = icon;
		m_enabled = enabled;
    ...
    public boolean getIsSubmitFormAction() {
        return m_submitFormAction;
    }
} // MenuEntry

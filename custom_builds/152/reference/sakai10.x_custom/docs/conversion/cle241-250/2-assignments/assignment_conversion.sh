...
CLASSPATH="$CLASSPATH:$TOMCAT_HOME/components/sakai-assignment-pack/WEB-INF/lib/sakai-assignment-impl-M2.jar"
CLASSPATH="$CLASSPATH:$TOMCAT_HOME/components/sakai-assignment-pack/WEB-INF/lib/sakai-db-conversion-M2.jar"
CLASSPATH="$CLASSPATH:$TOMCAT_HOME/components/sakai-assignment-pack/WEB-INF/lib/sakai-db-storage-M2.jar"
CLASSPATH="$CLASSPATH:$TOMCAT_HOME/components/sakai-assignment-pack/WEB-INF/lib/sakai-entity-util-M2.jar"
CLASSPATH="$CLASSPATH:$TOMCAT_HOME/components/sakai-assignment-pack/WEB-INF/lib/sakai-util-M2.jar"
...
CLASSPATH="$CLASSPATH:$TOMCAT_HOME/shared/lib/sakai-assignment-api-M2.jar"

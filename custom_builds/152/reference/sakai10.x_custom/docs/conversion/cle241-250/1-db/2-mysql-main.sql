-- This is the MySQL Sakai CLE 2.4.1 (or later) -> 2.5.0 conversion script
----------------------------------------------------------------------------------------------------------------------------------------
--
-- use this to convert a Sakai CLE database from 2.4.0 to 2.5.0.  Run this before you run your first app server.
-- auto.ddl needs to be enabled in your app server as well after running this script
--
----------------------------------------------------------------------------------------------------------------------------------------
...
-- (already in cle241sp2) alter table MFR_MESSAGE_T add DELETED bit not null default false;
...
update SAKAI_REALM_FUNCTION set function_name = 'reports.create' where function_name='osp.reports.create';
update SAKAI_REALM_FUNCTION set function_name = 'reports.view' where function_name='osp.reports.view';
update SAKAI_REALM_FUNCTION set function_name = 'reports.run' where function_name='osp.reports.run';
update SAKAI_REALM_FUNCTION set function_name = 'reports.edit' where function_name='osp.reports.edit';
update SAKAI_REALM_FUNCTION set function_name = 'reports.delete' where function_name='osp.reports.delete';
update SAKAI_REALM_FUNCTION set function_name = 'reports.share' where function_name='osp.reports.share';

-- osp.style.globalpublish already exists in the CLE DB, need to change its case
update SAKAI_REALM_FUNCTION set function_name='osp.style.globalPublish' where function_name='osp.style.globalpublish';
-- if prior statement fails, you will have to add the permission with the following statement
-- INSERT INTO SAKAI_REALM_FUNCTION VALUES (DEFAULT, 'osp.style.globalPublish');

-- the following osp permissions that are commented out here already exist in CLE 2.4.1sp2
...
-- citiation stuff not in rSmart CLE 241sp2, auto.ddl will take care of this
...
INSERT INTO PERMISSIONS_SRC_TEMP values ('Teaching Assistant','roster.viewenrollmentstatus');

INSERT INTO PERMISSIONS_SRC_TEMP values ('Student','roster.viewprofile');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Student','roster.viewofficialphoto');
...
INSERT INTO PERMISSIONS_SRC_TEMP values ('Tech Support','roster.viewallmembers');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Tech Support','roster.viewgroup');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Tech Support','roster.viewenrollmentstatus');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Tech Support','roster.viewprofile');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Tech Support','roster.viewofficialphoto');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Tech Support','roster.export');

INSERT INTO PERMISSIONS_SRC_TEMP values ('Organizer','roster.viewallmembers');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Organizer','roster.viewhidden');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Organizer','roster.viewgroup');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Organizer','roster.viewenrollmentstatus');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Organizer','roster.viewprofile');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Organizer','roster.viewofficialphoto');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Organizer','roster.export');

INSERT INTO PERMISSIONS_SRC_TEMP values ('Participant','roster.viewprofile');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Participant','roster.viewofficialphoto');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Participant','roster.viewallmembers');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Participant','roster.viewgroup');

INSERT INTO PERMISSIONS_SRC_TEMP values ('Reviewer','roster.viewprofile');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Reviewer','roster.viewofficialphoto');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Reviewer','roster.viewallmembers');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Reviewer','roster.viewgroup');

INSERT INTO PERMISSIONS_SRC_TEMP values ('Evaluator','roster.viewprofile');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Evaluator','roster.viewofficialphoto');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Evaluator','roster.viewallmembers');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Evaluator','roster.viewgroup');
...
-- the following are performed during the assignment conversion process
...
-- (rsmart cle: deleted template insert stmts; handled above)

-- 2 if need to update all existing realms
-- for each realm that has a role matching something in this table, we will add to that role the function from this table
-- edited for CLE roles
CREATE TABLE PERMISSIONS_SRC_TEMP (ROLE_NAME VARCHAR(99), FUNCTION_NAME VARCHAR(99));
...
INSERT INTO PERMISSIONS_SRC_TEMP values ('Teaching Assistant','site.upd.site.mbrshp');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Teaching Assistant','site.upd.grp.mbrshp');

INSERT INTO PERMISSIONS_SRC_TEMP values ('Organizer','site.upd.site.mbrshp');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Organizer','site.upd.grp.mbrshp');

INSERT INTO PERMISSIONS_SRC_TEMP values ('Tech Support','site.upd.site.mbrshp');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Tech Support','site.upd.grp.mbrshp');
...
-- following is in cle240->241 upgrade script, but not in 241 itself
-- create index SAM_ASSGRAD_AID_PUBASSEID_T on SAM_ASSESSMENTGRADING_T (AGENTID,PUBLISHEDASSESSMENTID);


----------------------------------------------------------------------------------------------------------------------------------------
-- backfill mailtool permissions into existing sites and groups
----------------------------------------------------------------------------------------------------------------------------------------
CREATE TABLE PERMISSIONS_SRC_TEMP (ROLE_NAME VARCHAR(99), FUNCTION_NAME VARCHAR(99));
CREATE TABLE PERMISSIONS_TEMP (ROLE_KEY INTEGER, FUNCTION_KEY INTEGER);
...
INSERT INTO PERMISSIONS_SRC_TEMP values ('Tech Support','mailtool.admin');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Tech Support','mailtool.send');

INSERT INTO PERMISSIONS_SRC_TEMP values ('Organizer','mailtool.admin');
INSERT INTO PERMISSIONS_SRC_TEMP values ('Organizer','mailtool.send');

INSERT INTO PERMISSIONS_SRC_TEMP values ('Participant','mailtool.send');

INSERT INTO PERMISSIONS_SRC_TEMP values ('Reviewer','mailtool.send');

INSERT INTO PERMISSIONS_SRC_TEMP values ('Evaluator','mailtool.send');

INSERT INTO PERMISSIONS_SRC_TEMP values ('Guest','mailtool.send');

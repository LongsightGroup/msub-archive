/**********************************************************************************
 * $URL: https://svn.rsmart.com/svn/vendor/branches/sakai-kernel/rsmart-cle/kernel-impl/src/main/java/org/sakaiproject/messagebundle/impl/MessageBundleServiceImpl.java $
 * $Id: MessageBundleServiceImpl.java 34650 2012-03-20 15:11:11Z ktakacs $
 ***********************************************************************************
 *
...
public class MessageBundleServiceImpl extends HibernateDaoSupport implements MessageBundleService {
   ...
   /**
    ...
    public void init() {
        ...
        if(autoDdl && sqlService != null && "mysql".equalsIgnoreCase(sqlService.getVendor())){
            sqlService.ddl(this.getClass().getClassLoader(), "sakai_message_bundle");
        }

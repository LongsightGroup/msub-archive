 ...
 * $URL: https://source.sakaiproject.org/contrib/evaluation/branches/1.3.x/tool/src/java/org/sakaiproject/evaluation/tool/producers/AdministrateProducer.java $
 * $Id: AdministrateProducer.java 69539 2010-08-02 09:04:09Z lovemore.nalube@uct.ac.za $
 **************************************************************************
...
public class AdministrateProducer implements ViewComponentProducer {
    ...
    public void fillComponents(UIContainer tofill, ViewParameters viewparams, ComponentChecker checker) {
        ...
        if (maxListLength == null) { minListLength = 40; }

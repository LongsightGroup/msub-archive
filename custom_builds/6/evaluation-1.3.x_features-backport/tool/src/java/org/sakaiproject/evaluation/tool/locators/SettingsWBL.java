 ...
 * $URL: https://source.sakaiproject.org/contrib/evaluation/branches/1.3.x/tool/src/java/org/sakaiproject/evaluation/tool/locators/SettingsWBL.java $
 * $Id: SettingsWBL.java 60047 2009-04-28 15:23:51Z aaronz@vt.edu $
 **************************************************************************
        ...
        if ( isTernaryBoolean(beanname) ) {
            ...
            if (toset instanceof String) {
                ...
                if (EvalSettings.EVAL_MIN_LIST_LENGTH.equals(beanname)) {
                    ...
                    int evalMax = (Integer) evalSettings.get(EvalSettings.EVAL_MAX_LIST_LENGTH);
                    if (evalMin < 1)
                        toset = 1;
                    ...
                    int evalMin = (Integer) evalSettings.get(EvalSettings.EVAL_MIN_LIST_LENGTH);

/**
 * $Id: PreloadDataImpl.java 67673 2010-05-17 23:47:31Z lovemore.nalube@uct.ac.za $
 * $URL: https://source.sakaiproject.org/contrib/evaluation/branches/1.3.x/impl/src/java/org/sakaiproject/evaluation/dao/PreloadDataImpl.java $
...
public class PreloadDataImpl {
    ...
    public void preloadEvalConfig() {
        ...
        if (count == 0) {
            ...
            saveConfig(EvalSettings.EVAL_MIN_LIST_LENGTH, 2);
            saveConfig(EvalSettings.EVAL_MAX_LIST_LENGTH, 40);

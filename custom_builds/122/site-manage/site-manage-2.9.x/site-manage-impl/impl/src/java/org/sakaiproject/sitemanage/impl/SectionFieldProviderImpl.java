...
public class SectionFieldProviderImpl implements SectionFieldProvider {
	...
	public List<SectionField> getRequiredFields() {
		...
		fieldList.add(new SectionFieldImpl(resourceLoader.getString("required_fields_subject"), null, 20));
		fieldList.add(new SectionFieldImpl(resourceLoader.getString("required_fields_course"), null, 10));
		fieldList.add(new SectionFieldImpl(resourceLoader.getString("required_fields_section"), null, 10));		

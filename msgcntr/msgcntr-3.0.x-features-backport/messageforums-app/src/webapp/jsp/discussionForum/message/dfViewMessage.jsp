...
<script type="text/javascript">
			...
			<f:verbatim><div class="singleMessage">
				...
				<h:panelGrid columns="2"  style="width: 100%;" border="0">
					<h:outputText rendered="#{ForumTool.selectedMessage.message.deleted && ForumTool.selectedMessage.message.showForumDeletes && !ForumTool.needToPostFirst}"  value="#{msgs.cdfm_msg_deleted_label}" styleClass="instruction"/>

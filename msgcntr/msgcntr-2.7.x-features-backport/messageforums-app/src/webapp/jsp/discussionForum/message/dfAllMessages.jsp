...
<!--jsp/discussionForum/message/dfAllMessages.jsp-->
		<link rel="stylesheet" type="text/css" href="../../css/TableSorter.css" />
  		<sakai:script contextBase="/messageforums-tool" path="/js/jquery-latest.min.js"/>
...
//--%>
		...
		<sakai:tool_bar separator="#{msgs.cdfm_toolbar_separator}">
 		...
 		<h:messages styleClass="alertMessage" id="errorMessages" />
			...
			<h:column id="_toggle" rendered="#{!message.deleted || message.showForumDeletes}">
				<f:facet name="header">
			...
			<h:column id="_msg_subject" rendered="#{!message.deleted || message.showForumDeletes}">
				<f:facet name="header">
				...
				<%-- Rendered to view current message only --%>
					...
					<h:panelGroup styleClass="inactive firstChild" rendered="#{message.deleted && (message.depth != 0 || message.childCount == 0) && message.showForumDeletes}" >
				...
				<%-- author column --%>
			<h:column rendered="#{!message.deleted || message.showForumDeletes}">
				<f:facet name="header">

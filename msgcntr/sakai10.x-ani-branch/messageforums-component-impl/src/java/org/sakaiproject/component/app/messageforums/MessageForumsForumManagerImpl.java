/**********************************************************************************
 * $URL: https://svn.rsmart.com/svn/vendor/branches/sakai/rsmart-cle/msgcntr/messageforums-component-impl/src/java/org/sakaiproject/component/app/messageforums/MessageForumsForumManagerImpl.java $
 * $Id: MessageForumsForumManagerImpl.java 34414 2012-03-09 17:08:54Z ktakacs $
 ***********************************************************************************
 *
...
public class MessageForumsForumManagerImpl extends HibernateDaoSupport implements MessageForumsForumManager {
  ...
  public List getReceivedUuidByContextId(final List siteList) {
    ...
    public PrivateForum getPrivateForumByOwnerArea(final String owner, final Area area) {
      ...
      PrivateForum pf = (PrivateForum) getHibernateTemplate().execute(hcb);
      //pf.getTopicsSet();
      return pf;
    }

/**********************************************************************************
 * $URL: https://svn.rsmart.com/svn/vendor/branches/sakai/rsmart-cle/msgcntr/messageforums-component-impl/src/java/org/sakaiproject/component/app/messageforums/ui/DiscussionForumManagerImpl.java $
 * $Id: DiscussionForumManagerImpl.java 32886 2011-12-08 22:03:02Z jbush $
 ***********************************************************************************
 *
...
public class DiscussionForumManagerImpl extends HibernateDaoSupport implements
  ...
  public boolean isInstructor(String userId, String siteId) {
    ...
    try {
		return isInstructor(userDirectoryService.getUser(userId), "/site/"+siteId);
	} catch (UserNotDefinedException e) {
   ...
   * @return
   */
  private boolean isInstructor(User user, String entityRef)
  {
    if (LOG.isDebugEnabled())
    {
      LOG.debug("isInstructor(User " + user + ", " + entityRef + ")");
    }
    if (user != null)
      return securityService.unlock(user, "site.upd", entityRef);
    else
      return false;
  }

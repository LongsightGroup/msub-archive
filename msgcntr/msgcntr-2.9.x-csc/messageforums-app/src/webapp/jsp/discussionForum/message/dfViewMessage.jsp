...
<script type="text/javascript">
			...
			<h:panelGrid columns="2" 
				...
				<h:panelGroup  style="display:block">
					...
					<%-- Email --%>
					<h:outputLink id="createEmail1" onclick="window.top.location='mailto:#{ForumTool.selectedMessage.authorEmail}?subject=Feedback on #{ForumTool.selectedMessage.message.title}';return false;" value="javascript:void(0);" rendered="#{ForumTool.selectedMessage.userCanEmail && ForumTool.selectedMessage.authorEmail != '' && ForumTool.selectedMessage.authorEmail != null}"> 

/**********************************************************************************
 * $URL: https://svn.rsmart.com/svn/vendor/branches/sakai-kernel/rsmart-cle/kernel-impl/src/main/java/org/sakaiproject/site/impl/SiteServiceSqlDefault.java $
 * $Id: SiteServiceSqlDefault.java 26198 2011-04-08 19:28:14Z jcrodriguez $
 ***********************************************************************************
 *
...
public class SiteServiceSqlDefault implements SiteServiceSql
{
   ...
   public String getToolsOfTypeFieldsSql()
   {
		return "select SAKAI_SITE_TOOL.TOOL_ID, SAKAI_SITE_TOOL.TITLE, LAYOUT_HINTS, SAKAI_SITE_TOOL.SITE_ID, PAGE_ID, SKIN, PUBLISHED, PAGE_ORDER "
				+ "from   SAKAI_SITE_TOOL, SAKAI_SITE " + "where  SAKAI_SITE_TOOL.SITE_ID = SAKAI_SITE.SITE_ID and REGISTRATION = ?";
   }

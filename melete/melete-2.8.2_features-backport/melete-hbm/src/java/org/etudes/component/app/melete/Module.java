...
public class Module implements Serializable,ModuleObjService {
    ...
    /*Custom constructor*/
    public Module(String title, String subtitle, String learnObj, String description, String keywords, String createdByFname, String createdByLname, String userId, String modifiedByFname, String modifiedByLname, String institute, String whatsNext, Date creationDate, Date modificationDate, String seqXml) {
        this.title = title;
        this.subtitle = subtitle;
        this.learnObj = learnObj;
        this.description = description;
    ...
    public Module(Module oldModule)
    {
    	...
    	this.subtitle = oldModule.getSubtitle();
	...
	public Boolean getGroupRestrictionFlag() {
		return groupRestrictionFlag;
	}

	public void setGroupRestrictionFlag(Boolean groupRestrictionFlag) {
		this.groupRestrictionFlag = groupRestrictionFlag;
	}

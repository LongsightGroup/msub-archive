...
public class MeleteSitePreference implements Serializable,MeleteSitePreferenceService{
	 ...
	 * @param editorChoice
	 */
	public MeleteSitePreference(String prefSiteId, Boolean printable, Boolean showInactiveModules) {
	...
	public Boolean getShowInactiveModules() {

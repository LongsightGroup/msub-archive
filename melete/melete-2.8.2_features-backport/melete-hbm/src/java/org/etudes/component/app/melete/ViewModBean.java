...
public class ViewModBean implements Serializable, ViewModBeanService {
    ...
    private Boolean groupRestrictionFlag;
	 ...
	 * @param vsBeans
	 */
	public ViewModBean(int moduleId, boolean selected, boolean dateFlag, boolean visibleFlag, String title, String subtitle, String rowClasses, String whatsNext, Date startDate, Date endDate, int seqNo, String seqXml, List vsBeans)
	{
		this.moduleId = moduleId;
		this.selected = selected;
		this.dateFlag = dateFlag;

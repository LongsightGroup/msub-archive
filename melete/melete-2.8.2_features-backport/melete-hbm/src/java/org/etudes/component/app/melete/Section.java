...
public class Section implements Serializable,SectionObjService {
    ...
    /** Custom constructor */
    public Section(String title, String subtitle, String createdByFname, String createdByLname, String modifiedByFname, String modifiedByLname, String instr, String contentType, boolean audioContent, boolean videoContent, boolean textualContent, boolean openWindow, boolean deleteFlag, Date creationDate, Date modificationDate) {
        this.title = title;
        this.subtitle = subtitle;
        this.createdByFname = createdByFname;
        this.createdByLname = createdByLname;
    ...
    public Section(Section oldSection) {
           ...
           this.subtitle = oldSection.getSubtitle();

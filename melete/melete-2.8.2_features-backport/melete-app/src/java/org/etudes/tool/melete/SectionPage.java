/**********************************************************************************
 *
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.8.2/melete-app/src/java/org/etudes/tool/melete/SectionPage.java $
 * $$
 * $Id: SectionPage.java 70550 2010-10-04 18:48:46Z rashmi@etudes.org $
 ************************************************************************************
 *
...
// to add spring dependency methods
	...
	{
		Boolean useSakaiResources = Boolean.parseBoolean(serverConfigurationService.getString("melete.useSakaiResources", "false"));
		
		if (useSakaiResources) {
			String attrb = "fck.security.advisor.meleteEditor";

...
function toggleGroupPanel(){
	var groupPanel = document.getElementById('AddModuleForm:groupAccess:groupPanel');
	var checkBox = document.getElementById('AddModuleForm:groupAccess:groupRestrictionFlag');
	if(!checkBox.checked){
	...
	setMainFrameHeight('<h:outputText value="#{addModulePage.winEncodeName}"/>');
}
</script>
       ...
       <tr>
         <td>
         	<table class="maintableCollapseWithNoBorder" >
              ...
              <tr>
                <td class="col1" align="left" valign="top"> <h:outputText rendered="#{addModulePage.showSubtitles}" value="#{msgs.add_module_module_subtitle}" /></td>
                <td class="col2" align="left" valign="top">
                  <h:inputText id="subtitle" rendered="#{addModulePage.showSubtitles}" size="45" value="#{addModulePage.module.subtitle}" styleClass="formtext" />
                </td>
              </tr>
...
<f:subview id="noGroupAccess" rendered="#{!addModulePage.siteHasGroups}">
        <h:selectBooleanCheckbox id="groupRestrictionFlag" title="groupRestrictionFlag" value="#{addModulePage.module.groupRestrictionFlag}" style="display: none"/>
		  ...
		  <f:subview id="groupAccess" rendered="#{addModulePage.siteHasGroups}">
          <f:verbatim>
          <tr>
          ...
          <f:verbatim>
            ...
            <td  class="col2" valign="top">
             ...
             <h:selectBooleanCheckbox id="groupRestrictionFlag" title="groupRestrictionFlag" value="#{addModulePage.module.groupRestrictionFlag}" onchange="toggleGroupPanel();">
	         </h:selectBooleanCheckbox>
	      ...
	      <f:verbatim>
	      		...
	      		<h:panelGroup id="groupPanel" styleClass="shorttext">
			    	...
			    	<h:selectOneListbox size="1" id="availableGroup" value ="#{addModulePage.selectedAvailableGroup}" onchange="this.form.submit();"
						                  valueChangeListener="#{addModulePage.processActionAddGroup}">
				      <f:selectItems value="#{addModulePage.availableGroups}"/>
				    </h:selectOneListbox>
				    
				    <h:dataTable id="table"  value="#{addModulePage.accessGroups}"   styleClass="listHier lines nolines" style="width: auto" var="accessGroup"  border="0" rendered="#{!empty addModulePage.accessGroups}">
					  <h:column>
						   <f:facet name="header">
								<h:panelGroup>
	  						...
	  						<h:commandLink action="#{addModulePage.processActionRemoveGroup}">
	  				...
	  				<h:outputText value="#{msgs.edit_module_no_groups}" styleClass="BlueClass" rendered="#{empty addModulePage.accessGroups}"/>
	  				<f:verbatim>
	      				</div>
	      			</f:verbatim>
			    </h:panelGroup> 		
	      		<f:subview id="siteHideGroupsView" rendered="#{!addModulePage.module.groupRestrictionFlag}">
					<f:verbatim>

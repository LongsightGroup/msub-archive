...
<sakai:tool_bar>
  ...
  <sakai:tool_bar_item disabled="#{!navPage.shouldRenderPreferences}" immediate="true" value="#{msgs.topnavbar_preferences}" action="#{navPage.PreferenceAction}"/>
   ...
   <h:outputLink id="printModuleLink" value="#" onclick="OpenPrintWindow('*','Melete Print Window');" rendered="#{listModulesPage.printable}">
  	    <h:graphicImage id="printImgLink" value="/images/printer.png"  alt="#{msgs.list_auth_modules_alt_print_all}" title="#{msgs.list_auth_modules_alt_print_all}" styleClass="AuthImgClass"/>
   </h:outputLink>

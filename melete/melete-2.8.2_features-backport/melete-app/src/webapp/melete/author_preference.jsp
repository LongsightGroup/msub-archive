    		   ...
    		   <tr>
				...
				<tr>
				  <td>
				   ...
				   <h:panelGrid styleClass="authorPrefTable">
                	 <h:column>
                		<h:outputText id="t5" value="#{msgs.author_preference_show_inactive}"  styleClass="bold"/>
                	</h:column>
                	 <h:column>
						<h:selectOneRadio value="#{authorPreferences.materialShowInactiveModules}" layout="pageDirection">
								<f:selectItem itemLabel="#{msgs.author_preference_yes}" itemValue="true" />
								<f:selectItem itemLabel="#{msgs.author_preference_no}" itemValue="false"/>
						</h:selectOneRadio>		
					</h:column>

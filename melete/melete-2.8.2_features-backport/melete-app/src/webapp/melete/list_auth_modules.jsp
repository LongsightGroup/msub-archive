...
   <h:column>
     ...
     <h:commandLink id="showHideSections" action="#{listAuthModulesPage.showHideSections}" immediate="true">
      ...
      <f:verbatim><br /></f:verbatim><h:outputText id="subtitle2" rendered="#{listAuthModulesPage.showSubtitles}" value="#{mdbean.module.subtitle}" styleClass="indent"></h:outputText>
      ...
      <h:dataTable id="tablesec" rendered="#{((mdbean.moduleId == listAuthModulesPage.showModuleId)||(listAuthModulesPage.expandAllFlag == listAuthModulesPage.trueFlag))}"
              ...
              <f:verbatim><br /></f:verbatim><h:outputText id="secSubtitle" rendered="#{listAuthModulesPage.showSubtitles}" value="#{sectionBean.section.subtitle}" styleClass="indent"></h:outputText>
            </h:column>
          </h:dataTable>     
        </h:column>      
       <h:column>

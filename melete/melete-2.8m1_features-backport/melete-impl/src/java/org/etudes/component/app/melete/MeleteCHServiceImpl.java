/**********************************************************************************
 *
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.8m1/melete-impl/src/java/org/etudes/component/app/melete/MeleteCHServiceImpl.java $
 * $Id: MeleteCHServiceImpl.java 68076 2010-06-08 18:12:34Z rashmi@etudes.org $
 ***********************************************************************************
 *
				...
				try
				{
					if (numberStr != null && !checkDup.equals(Validator.escapeResourceName(name)))
					{
						edit = getContentservice().editResource(resource.getId());
                                                //edit.setResourceType(ResourceType.TYPE_URL);
						ResourcePropertiesEdit rp = edit.getPropertiesEdit();

/**********************************************************************************
 *
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.8.2/melete-impl/src/java/org/etudes/component/app/melete/ModuleDB.java $
 * $Id: ModuleDB.java 71247 2010-11-09 00:27:09Z mallika@etudes.org $
 ***********************************************************************************
 *
...
//		    			Associate vsBeans to vmBean
		    			...
		    			if ((prevModId == 0)||(moduleId != prevModId))
		    			{
		    				...
		    				if (accMap.size() > 0)
		    				{
		    					//since this user has special access, set the group filter to false:
		    					vmBean.setGroupRestrictionFlag(false);

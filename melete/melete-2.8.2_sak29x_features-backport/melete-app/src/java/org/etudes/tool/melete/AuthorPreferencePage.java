...
public class AuthorPreferencePage {
  ...
  private String materialShowInactiveModules="false";
  ...
  public void setEditorFlags()
  {
	  ...
	  if(editorChoice.equals(SFERYX))
	  {
		...
		else if (editorChoice.equals(FCKEDITOR) || editorChoice.equals(CKEDITOR) || editorChoice.equalsIgnoreCase("ckeditor"))
	  {
		  shouldRenderSferyx = false;
  ...
  private void getUserChoice()
  {
		...
		setEditorFlags();
 		...
 		if(msp == null)
 		{
  		...
  		//set materialShowInactiveModules
  		if(msp == null)
  		{
  			materialShowInactiveModules = ServerConfigurationService.getString("melete.showInactiveModules", "true");
  		}
  		else if(msp != null && msp.getShowInactiveModules() == null)
  		{
  			materialShowInactiveModules = ServerConfigurationService.getString("melete.showInactiveModules", "true");
  		} else materialShowInactiveModules = msp.getShowInactiveModules().toString();
  ...
  public String getMeleteDefaultEditor()
	{
		...
		if(defaultEditor == null || defaultEditor.length() == 0)
		{
			...
			if (defaultEditor.equalsIgnoreCase(FCKEDITOR) || defaultEditor.equalsIgnoreCase(CKEDITOR) ||  defaultEditor.startsWith("FCK") || defaultEditor.startsWith("fck") || defaultEditor.equalsIgnoreCase("ckeditor"))
...
private void setChoices() throws Exception
{
	...
	//set materialShowInactiveModules preference
	if(materialShowInactiveModules.equals("true"))msp.setShowInactiveModules(true);
	else msp.setShowInactiveModules(false);
...
public boolean isMaterialShowInactiveModules(String site_id)
{
	Boolean defaultShowInactiveModules = new Boolean(ServerConfigurationService.getString("melete.showInactiveModules", "true"));
	MeleteSitePreference checkMsp = (MeleteSitePreference)getAuthorPref().getSiteChoice(site_id);
	if(checkMsp != null && checkMsp.getShowInactiveModules() != null)return checkMsp.getShowInactiveModules();
	else return defaultShowInactiveModules.booleanValue();
}
...
public String getMaterialShowInactiveModules() {
	return materialShowInactiveModules;
}

public void setMaterialShowInactiveModules(String materialShowInactiveModules) {
	this.materialShowInactiveModules = materialShowInactiveModules;
}

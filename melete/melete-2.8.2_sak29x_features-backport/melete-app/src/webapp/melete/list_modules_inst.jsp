...
<!--
 ***********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/etudes/melete/tags/2.8.2/melete-app/src/webapp/melete/list_modules_inst.jsp $
 * $Id: list_modules_inst.jsp 70438 2010-09-27 20:50:02Z rashmi@etudes.org $  
 ***********************************************************************************
 *
...
<h:messages showDetail="true" showSummary="false"/>
 ...
 <h:dataTable id="StudentTable"  
      ...
      <h:commandLink id="viewModule2"  actionListener="#{listModulesPage.viewModule}" action="#{listModulesPage.redirectToViewModule}"  immediate="true" 
       ...
       <f:verbatim><br /></f:verbatim><h:outputText rendered="#{listModulesPage.showSubtitles}" value="#{vmbean.subtitle}" styleClass="indent"></h:outputText>
           ...
           <h:commandLink id="viewSectionLink2"  actionListener="#{listModulesPage.viewSection}" action="#{listModulesPage.redirectToViewSectionLink}" rendered="#{((vsbean.contentType != listModulesPage.typeLink)&&(vmbean.visibleFlag != listModulesPage.trueFlag))}" immediate="true">
             ...
             <f:verbatim><br /></f:verbatim><h:outputText rendered="#{listModulesPage.showSubtitles}" value="#{vsbean.subtitle}" styleClass="indent"></h:outputText>
            </h:column>
          </h:dataTable>

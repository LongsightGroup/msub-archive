...
<h:column>
 	...
 	<f:verbatim><br /></f:verbatim><h:outputText id="subtitle" rendered="#{viewSectionsPage.showSubtitles}" value="#{viewSectionsPage.section.subtitle}" styleClass="bold style7"></h:outputText>    
</h:column>
<h:column>

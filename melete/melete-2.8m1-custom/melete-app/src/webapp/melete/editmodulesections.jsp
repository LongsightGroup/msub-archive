                   ...
                   <!-- table header -->
			          ...
			          <tr>
	                   ...
	                   <!-- end table header -->
                                  ...
                                  <tr>
                                    <td class="col1" align="left" valigb="top"><h:outputText id="text7b" rendered="#{editSectionPage.showSubtitles}" value="#{msgs.editmodulesections_section_subtitle}" /></td>
                                    <td class="col2" align="left" vlagin="top">
                                    <h:inputText id="subtitle" rendered="#{editSectionPage.showSubtitles}" value="#{editSectionPage.section.subtitle}" size="45" styleClass="formtext" />
                                    </td>
                                  </tr>                                  
                                  <tr>
